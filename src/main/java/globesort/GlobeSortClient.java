...
public class GlobeSortClient {
    ...
    public void run(Integer[] values) throws Exception {
        ...
        */
        ...
        System.out.println("The run time for sorting in server is " + responseVal[0] + " s.");
        ...
        System.out.println("The run time for one-time Network is " + (elapsedTime - responseVal[0]) / (double)(2)); 
        System.out.println("The throughput for one-time Network is " + size * 2 /(double) (elapsedTime - responseVal[0]));         
